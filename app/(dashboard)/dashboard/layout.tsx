...
import { Users, CircleUser, Factory, BanknoteArrowUp, DollarSign, Wallet, Settings, Shield, Activity, Menu, Boxes } from 'lucide-react';
...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: '/dashboard/clientes', icon: CircleUser , label: 'Clientes' },
